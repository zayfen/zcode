...
pub type StreamingResponse = Pin<Box<dyn Stream<Item = zcode_core::Result<String>> + Send>>;
...
pub trait StreamHandler: Send + Sync {
    ...
    fn on_error(&mut self, error: &zcode_core::ZcodeError);
}

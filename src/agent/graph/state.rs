...
/// Default state implementation that covers most use cases.
...
pub struct DefaultState {
    ...
    /// Final result (set when graph completes)
    pub result: Option<TaskResult>,
    /// Agent lifecycle state
    pub agent_state: AgentState,
    /// Arbitrary key-value metadata (used by routers)
    pub metadata: HashMap<String, serde_json::Value>,
    /// How many node iterations have run
    pub iteration: usize,
}
